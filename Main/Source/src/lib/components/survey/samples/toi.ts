	...
	questions: [
		...
		},
		{
			...
			items: [
				...
				'5. Comunicación y colaboración on-line',
				'6. Comunicarse por correo electrónico o mensajería por plataformas digitales(meet, zoom, whatsapp, entre otras)',
				'7. Comunicarse por videollamadas',
				'8. Creación de contenidos digitales',
				'9. Crear y editar contenidos digitales',
			],
